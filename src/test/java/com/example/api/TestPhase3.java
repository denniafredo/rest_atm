...
public class TestPhase3 {
    ...
    public void testLoginSuccess() throws URISyntaxException {
        ...
        Assert.assertEquals("Hello, Alice!", result.getBody().getMessage().get(0));
        Assert.assertEquals(200, result.getStatusCodeValue());
    ...
    public void testTransferSuccess() throws URISyntaxException {
        ...
        TransferDTO transferDTO = new TransferDTO("Bob", 30.0);
        ...
        Assert.assertEquals("Your balance is $210.0", result.getBody().getMessage().get(0));
        Assert.assertEquals("Owed $10.0 from Bob", result.getBody().getMessage().get(1));
        Assert.assertEquals(200, result.getStatusCodeValue());
